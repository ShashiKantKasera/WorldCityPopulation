...
var taji = L.geoJSON(data, {
    onEachFeature: function (feature, layer) {
        layer.bindPopup('City -' + feature.properties.city + '<br /> ' + 'Country -'+ feature.properties.country + '<br /> ' +'Population -'+ feature.properties.population);
    }
});
taji.addTo(marker);
marker.addTo(map);
...
var overlayMaps = {
    'World Cities Population': marker
